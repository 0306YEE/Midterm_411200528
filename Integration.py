...
def delete_student():
    student_id = entry_id.get()
    curson.execute('SELECT = from DB_student where db_student_id =?' , (student_id,))
...
botton_remove = tk.Button(root, text='remove', command=overview_student)
botton_remove.pack(pady=24)
